...
#define CPU_MAP_STM32F7XX // STM32F7XX CPU
...
// #define INVERT_CONTROL_PIN_MASK ((1<<CONTROL_FEED_HOLD_BIT)|(1<<CONTROL_SAFETY_DOOR_BIT)|(1<<CONTROL_RESET_BIT)) // Default disabled.
