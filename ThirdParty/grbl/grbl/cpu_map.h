...
// Define step direction output pins. NOTE: All direction pins must be on the same port.
#define X_DIRECTION_GPIO_GROUP GPIOA
#define Y_DIRECTION_GPIO_GROUP GPIOB
#define Z_DIRECTION_GPIO_GROUP GPIOA
#define X_DIRECTION_PORT X_DIRECTION_GPIO_GROUP->ODR
#define Y_DIRECTION_PORT Y_DIRECTION_GPIO_GROUP->ODR
#define Z_DIRECTION_PORT Z_DIRECTION_GPIO_GROUP->ODR
#define X_DIRECTION_BIT 4                                                                         // PA4
#define Y_DIRECTION_BIT 11                                                                        // PB11
#define Z_DIRECTION_BIT 5                                                                         // PA5
#define DIRECTION_MASK ((1 << X_DIRECTION_BIT) | (1 << Y_DIRECTION_BIT) | (1 << Z_DIRECTION_BIT)) // All direction bits

// Define stepper driver enable/disable output pin.
#define STEPPERS_DISABLE_GPIO_GROUP GPIOF
#define STEPPERS_DISABLE_PORT STEPPERS_DISABLE_GPIO_GROUP->ODR
...
// Define user-control controls (cycle start, reset, feed hold) input pins.
// NOTE: All CONTROLs pins must be on the same port and not on a port with other input pins (limits).
#define CONTROL_GPIO_GROUP GPIOE
#define CONTROL_PIN CONTROL_GPIO_GROUP->IDR
#define CONTROL_RESET_BIT 3       // PE3 EXTI3
#define CONTROL_FEED_HOLD_BIT 4   // PE4 EXTI4
#define CONTROL_CYCLE_START_BIT 5 // PE5 EXTI9_5
#define CONTROL_SAFETY_DOOR_BIT 4 // PE4 EXTI4; NOTE: Safety door is shared with feed hold. Enabled by config define.
#define CONTROL_MASK ((1 << CONTROL_RESET_BIT) | (1 << CONTROL_FEED_HOLD_BIT) | (1 << CONTROL_CYCLE_START_BIT) | (1 << CONTROL_SAFETY_DOOR_BIT))
#define CONTROL_INVERT_MASK CONTROL_MASK // May be re-defined to only invert certain control pins.

// Define probe switch input pin.
#define PROBE_GPIO_GROUP GPIOE
...
#define REALTIME_OUTPUT_PIN bit(USER_OUTPUT_0_BIT)
